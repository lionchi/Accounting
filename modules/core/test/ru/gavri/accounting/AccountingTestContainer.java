...
public class AccountingTestContainer extends TestContainer {

    public AccountingTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/gavri/accounting/app.properties",
    ...
    public static class Common extends AccountingTestContainer {

        public static final AccountingTestContainer.Common INSTANCE = new AccountingTestContainer.Common();
